...
xcli -e init -r "jnu-cloud||jnjsoftone||ts-swc-npm||Jnjsoft Nodejs Utility Library for Cloud(gdrive, gsheet, notion, ...) Support Functions in Typescript"
```
...
cd C:/JnJ/Developments/Utils/jnu-cloud
